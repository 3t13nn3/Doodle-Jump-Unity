...
public class TopScores : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        List<playersScore> l_ordered = l.OrderByDescending(o => o.playerScore).ToList();
        ...
        for (int i = 0; i < nbr; i++)
        {
            ...
            entryTransform.Find("playerName").GetComponent<TextMeshProUGUI>().text = l_ordered[i].playerName;
            entryTransform.Find("playerScore").GetComponent<TextMeshProUGUI>().text = l_ordered[i].playerScore + "";
        }
    }
}